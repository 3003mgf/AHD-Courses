    ...
    <div className="w-full min-h-screen dark:bg-[#141414]">
      ...
      <div className="w-full flex items-end flex-col relative">
        ...
        <div className="w-full h-[60vh] pb-[77px] flex items-end justify-start px-[60px] relative overflow-visible bg-[#F2F0EA99] dark:bg-[#141414]">
          <div className="w-full flex items-start justify-start z-10">
            <div className="w-[23.5%] flex flex-col">
              <p className="text-[10px] tracking-[0.05em] text-[#FFA300] font-SatoshiBold leading-none mt-[20px]">
                WORKSHOP •
              </p>
            ...
            <div className="w-[76.5%] flex flex-col relative">
              ...
              <div className="flex items-center mt-6 px-[4px]">
                ...
                <div className="flex overflow-visible">
                  <div className="w-[36px] h-[36px] rounded-full bg-[#1D1D1D50] dark:bg-[#21212199] border-[0px] border-[#FFFEFE] ring-[0px] ring-[#E9E6DE]"></div>
                  <div className="w-[36px] h-[36px] rounded-full bg-[#1D1D1D50] dark:bg-[#21212199] border-[0px] border-[#FFFEFE] ring-[0px] ring-[#E9E6DE] -ml-[6%]"></div>
                  <div className="w-[36px] h-[36px] rounded-full bg-[#1D1D1D50] dark:bg-[#21212199] border-[0px] border-[#FFFEFE] ring-[0px] ring-[#E9E6DE] -ml-[6%]"></div>
                  <div className="w-[36px] h-[36px] rounded-full bg-[#1D1D1D50] dark:bg-[#21212199] border-[0px] border-[#FFFEFE] ring-[0px] ring-[#E9E6DE] -ml-[6%]"></div>
                </div>
              ...
              <div className="absolute top-[20px] right-0 flex items-center gap-x-5">
                <div className="px-[8px] py-[4px] h-[20px] bg-[#FFE0B9] dark:bg-[#445406] myFlex rounded-md">
        ...
        <div className="w-full h-[55vh] flex items-center gap-x-[75px] pl-[23.5%] bg-[#F2F0EA20] dark:bg-[#111111] px-[60px] relative">
          ...
          <div className="w-1/2 flex flex-col px-[4px] -mt-[38px]">
            <p className="text-[10px] tracking-[0.05em] text-[#FFA300] font-SatoshiBold leading-none px-[1.5px] uppercase">
              ~ Overview
            </p>
      ...
      <div className="w-full bg-gradient-to-b from-[#F2F0EA99] via-transparent to-transparent dark:from-[#141414]">
        ...
        <div className="w-full px-[120px] mt-[175px] myFlex">
          <div className="w-full h-[500px] rounded-[24px] bg-[#F2F0EA99] dark:bg-[#171717] p-[60px] flex flex-col">
            ...
            <div className="flex items-start justify-between mt-5">
              ...
              {/* Middle */}
              <div className="w-[30%] flex flex-col">
                <p className="text-[11px] tracking-[0.05em] text-[#414141] dark:text-[#E9E6DE] font-SatoshiBold leading-none uppercase mt-[20px] px-[0.25px]">
                  CONBALU
                </p>


                <p className="w-full h-[190px]"></p>
                {/* <p className="w-[90%] mt-7 text-[#787777] text-[12.5px] syne-mono leading-[1.6] px-[0.25px]">
                  Balu Co is a social media expert and recognized content creator, known for helping brands grow online with creative strategies.
                  <br /><br />
                  Based in Miami, she’s a certified Wix Studio pro, teaching you how to create stunning websites that stand out and sell.
                </p> */}

                <button className="w-[150px] h-[40px] rounded-full bg-[#414141] dark:bg-[#F2B347] mt-6">
                  <p className="text-[10px] tracking-[0.05em] text-[#FFFEF3] font-SatoshiBold leading-none uppercase">
                    ~ JOIN ~
                  </p>
                </button>

                {/* <p className="text-[12.5px] text-[#787777] syne-mono leading-none mt-10">
                  If you want to know more about Balu Co.
                </p> */}
              </div>
      ...
      {/* AI */}
      <div className="w-full px-[120px] mt-[175px] hidden">
        <div className="w-full h-[550px] rounded-[24px] bg-[#F2F0EA99] p-[60px] flex flex-col">
          <p className="text-[10px] tracking-[0.05em] text-[#FFA300] font-SatoshiBold leading-none">
            AI •
          </p>

          {/* Container (Left - Middle - Right) */}
          <div className="w-full h-full flex items-start justify-between mt-5">
            {/* Left */}
            <div className="w-[30%] flex flex-col">
              <p className="text-[#414141] text-[40px] font-SatoshiBlack leading-[1.2] pb-[5px]">
                Life's Better
                <br />
                — Using AI.
              </p>

              <p className="text-[10px] tracking-[0.05em] text-[#d7d4cd] font-SatoshiBold leading-none uppercase mt-7">
                # GUIDANCE
              </p>
            </div>
      ...
      <div className="w-full px-[120px] mt-[190px] flex flex-col">
        ...
        <div className="w-full flex gap-x-5 mt-[50px]">
          {data.map((_, index) =>(
            <FeaturedCard key={`FEATURED_COURSE_${index}`} index={index}/>
          ))}
        </div>
      </div>
